function init() 
   ...
   elseif robot.id == 'block00' then
      robot.directional_leds.set_all_colors('black')
   elseif robot.id == 'block11' then
      robot.directional_leds.set_all_colors('magenta')
   elseif robot.id == 'block22' then
      robot.directional_leds.set_all_colors('orange')
   elseif robot.id == 'block33' then
      robot.directional_leds.set_all_colors('green')
   elseif robot.id == 'block44' then
      robot.directional_leds.set_all_colors('blue')
   elseif robot.id == 'block000' then
      robot.directional_leds.set_all_colors('black')
   elseif robot.id == 'block111' then
      robot.directional_leds.set_all_colors('magenta')
   elseif robot.id == 'block222' then
      robot.directional_leds.set_all_colors('orange')
   elseif robot.id == 'block333' then
      robot.directional_leds.set_all_colors('green')
   elseif robot.id == 'block444' then
      robot.directional_leds.set_all_colors('blue')
   else
      robot.directional_leds.set_all_colors('black')
   end
